...
public class AccurevSCM extends SCM {
    ...
    public boolean pollChanges(AbstractProject project, Launcher launcher, FilePath workspace, TaskListener listener) throws IOException, InterruptedException {
    	...
    	final String accurevPath = server.getExecutable();
    ...
    public static final class AccurevSCMDescriptor extends SCMDescriptor<AccurevSCM> implements ModelObject {
        ...
        public String getExecutable() {
            return new FindAccurevHome().invoke();
        }
    }
    ...
    public static final class AccurevServer {
        ...
        public AccurevServer(String name, String host, int port, String username, String password, String executable) {
            this.name = name;
            this.host = host;
            this.port = port;
         ...
         *
         * @return Value for property 'executable'.
         */
        public String getExecutable() {
         ...
         *
         * @param password Value to set for property 'executable'.
         */
