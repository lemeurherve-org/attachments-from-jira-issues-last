		...
		if (StringUtils.isNotBlank(httpProxy)) {
			...
			if (StringUtils.isNotBlank(proxyAuthentication)) {
				...
				*/
				...
				StandardCredentials credential = CredentialsProvider.findCredentialById(proxyAuthentication, 
				                                                                        StandardCredentials.class, 
				                                                                        run, 
				                                                                        URIRequirementBuilder.fromUri(url).build());
		...
		if (authentication != null && !authentication.isEmpty()) {
			...
			if (auth == null) {
				...
				*/
				...
				StandardCredentials credential = CredentialsProvider.findCredentialById(authentication, 
				                                                                        StandardCredentials.class, 
				                                                                        run, 
				                                                                        URIRequirementBuilder.fromUri(url).build());
                                CredentialsProvider.trackAll(run, credential);
