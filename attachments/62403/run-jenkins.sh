...
# AWS logStreamNames must be less than 100 characters
#
# https://issues.jenkins.io/browse/JENKINS-72924

JENKINS_WAR_VERSION=2.440.2
...
java -jar ../$PLUGIN_MANAGER_JAR --jenkins-version $JENKINS_WAR_VERSION --latest false --plugin-download-directory plugins --plugin-file mwaite-plugins.txt
