...
# Unable to open pipeline syntax OpenText Application Automation Tools Version 24.2 is installed
#
# https://issues.jenkins.io/browse/JENKINS-73374

JENKINS_WAR_VERSION=2.463
